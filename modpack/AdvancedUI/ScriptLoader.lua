...
function AdvancedUI.GUIUpdate_DiplomacyResType()
	...
	XGUIEng.SetText(XGUIEng.GetCurrentWidgetID(), name)
	if AdvancedUI.DiplomacyResDropdown:IsDropdownAttachedTo(w) then
		XGUIEng.SetMaterialTexture(w, 0, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32.png")
		XGUIEng.SetMaterialTexture(w, 1, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_hi.png")
		XGUIEng.SetMaterialTexture(w, 2, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_sel.png")
		XGUIEng.SetMaterialTexture(w, 3, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_in.png")
		XGUIEng.SetMaterialTexture(w, 4, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_akt.png")
	else
		XGUIEng.SetMaterialTexture(w, 0, "data\\graphics\\textures\\gui\\dropdown\\dropmenuup187x32.png")
		XGUIEng.SetMaterialTexture(w, 1, "data\\graphics\\textures\\gui\\dropdown\\dropmenuup187x32_hi.png")
		XGUIEng.SetMaterialTexture(w, 2, "data\\graphics\\textures\\gui\\dropdown\\dropmenuup187x32_sel.png")
		XGUIEng.SetMaterialTexture(w, 3, "data\\graphics\\textures\\gui\\dropdown\\dropmenuup187x32_in.png")
		XGUIEng.SetMaterialTexture(w, 4, "data\\graphics\\textures\\gui\\dropdown\\dropmenuup187x32_akt.png")
	end
end
...
function AdvancedUI.InitUI()
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_Scrollable", 0, "data\\graphics\\textures\\gui\\window_bg187x32.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_Scrollable", 1, "data\\graphics\\textures\\gui\\window_bg187x32.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_Scrollable", 2, "data\\graphics\\textures\\gui\\window_bg187x32.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_Scrollable", 3, "data\\graphics\\textures\\gui\\window_bg187x32.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_Scrollable", 4, "data\\graphics\\textures\\gui\\window_bg187x32.png")
	...
	CppLogic.UI.WidgetMaterialSetTextureCoordinates("DiplomacyWindowResDropdown_DropBG", 0, 0.75, 0.4000000059604645, 0.15000000596046448, 0.4000000059604645)
	XGUIEng.SetMaterialTexture("DiplomacyWindowResDropdown_DropBG", 0, "data\\graphics\\textures\\gui\\bg_windowcomplete.png")
	XGUIEng.SetMaterialColor("DiplomacyWindowResDropdown_DropBG", 0, 255, 255, 255, 255)
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowPlayerMPResourceName", 0, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowPlayerMPResourceName", 1, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_hi.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowPlayerMPResourceName", 2, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_sel.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowPlayerMPResourceName", 3, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_in.png")
	...
	XGUIEng.SetMaterialTexture("DiplomacyWindowPlayerMPResourceName", 4, "data\\graphics\\textures\\gui\\dropdown\\dropmenudown187x32_akt.png")
